				...
				<nav aria-label="breadcrumb">
					<ol className="breadcrumb">
					    <li className="breadcrumb-item">
	 				    ...
	 				    <li className="breadcrumb-item">
	 				    	<Link to="/admin/galleries"><Icon.Image height={16}/> galleries</Link>
	 				    </li>
					    <li className="breadcrumb-item active" aria-current="page">Create Gallery</li>
					</ol>
				</nav>

				<div className="position-relative">
					<div className="position-absolute bottom-0 end-0 top-50">
						<Link className="btn btn-sm btn-outline-primary" to="/admin/galleries">
